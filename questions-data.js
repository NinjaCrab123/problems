const QUESTION_BANK = [
  ...
  },
  {
    ...
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "20 slots on a shelf. Place exactly 7 identical books so they form: exactly one triplet (3), one pair (2), and two isolated singles (1, 1).",
    "solution_latex": "Answer: (14 choose 4) * (4! / 2!)\n\nLogic:\n1. Identify blocks: [BBB], [BB], [B], [B]. (4 abstract entities).\n2. Spacers: 20 slots - 7 books = 13 total empties.\n3. To separate 4 entities, you need 3 mandatory spacers.\n4. Free empties: 13 - 3 = 10 free empties.\n5. Create slots: 10 free empties + 4 entities = 14 slots. Choose 4.\n6. Arrange the blocks: You have 4 blocks, but two of them are identical\nsingles [B] and [B]. So arrange them using the permutation trap: 4! / 2!."
  },
  {
    "id": "Q0281",
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "20 chairs in a circle. Seat 4 knights so no two touch.",
    "solution_latex": "Answer: [ 20 * (15 choose 3) ] / 4\n\nLogic:\n1. Anchor trick: Pick ANY of the 20 chairs for Knight #1 (20 choices).\n2. This kills the 2 neighboring chairs, leaving 17 valid chairs in a\nstraight line to place the remaining 3 knights.\n3. 17 chairs - 3 knights = 14 empties. 14 - 2 mandatory spacers = 12\nfree empties. 12 free + 3 knights = 15 slots. Choose 3 -> (15 choose 3).\n4. THE TRAP: Because all 4 knights are effectively \"identical size-1\nblocks\", any of the 4 knights could have been the one chosen to be the\nanchor. You accidentally counted every table 4 times. Divide by 4!"
  },
  {
    "id": "Q0282",
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "Randomly guess 6 True, 9 False on a 15-question test. Probability of getting exactly TWO pairs of Trues and TWO isolated Trues? (Blocks: [TT], [TT], [T], [T]).",
    "solution_latex": "Answer: [ (10 choose 4) * (4! / (2! * 2!)) ] / (15 choose 6)\n\nLogic:\n1. PROBABILITY BOTTOM: Total ways to arrange 6 T's and 9 F's = 15 choose 6.\n2. PROBABILITY TOP: Use the 9 F's as physical \"walls\".\n3. 9 walls create 10 gaps. Choose 4 gaps for your 4 'True' blocks.\n4. Arrange the chosen blocks: 4 blocks total, but two are identical [TT]\nand two are identical [T]. Divide them out: 4! / (2! * 2!)."
  },
  {
    "id": "Q0283",
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "6 distinct Dogs, 4 identical Cats in a line. Dog A & B are fused. No two Cats can touch.",
    "solution_latex": "Answer: 5! * 2! * (6 choose 4)\n\nLogic:\n1. Fuse dogs: [A-B]. Remaining walls: 1 block + 4 single dogs = 5 entities.\n2. Arrange the 5 distinct walls (5!). Arrange inside the block (2!).\n3. 5 walls naturally create 6 gaps.\n4. Drop the 4 identical Cats into the chosen gaps: (6 choose 4)."
  },
  {
    "id": "Q0284",
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "5 distinct Wizards, 3 identical Orbs in a circle. No Orbs touch.",
    "solution_latex": "Answer: 4! * (5 choose 3)\n\nLogic:\n1. The Wizards are the walls. Anchor 1 Wizard to kill the circle.\nArrange the remaining 4 Wizards in the straight line: (4!).\n2. In a circle, 5 walls naturally create EXACTLY 5 gaps.\n3. Drop the 3 identical Orbs into those gaps: (5 choose 3)."
  },
  {
    "id": "Q0285",
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "LUMBERJACK (10 distinct letters). Probability that the 3 vowels (U, E, A) do NOT all appear fused together?",
    "solution_latex": "Answer: 1 - [ (8! * 3!) / 10! ]\n\nLogic:\n1. PROBABILITY BOTTOM: Total random arrangements = 10!.\n2. PROBABILITY TOP (\"BAD\" ways): Fuse [UEA]. 1 block + 7 consonants =\n8 entities. Arrange entities (8!), arrange inside block (3!).\n3. COMPLEMENT: Subtract the probability of the \"bad\" ways from 1."
  },
  {
    "id": "Q0286",
    "theme": "Combinatorics & Geometry",
    "difficulty": "Very Hard",
    "question_latex": "10 distinct people in a circle. Probability that P1, P2, and P3 all sit together in a single block?",
    "solution_latex": "Answer: (7! * 3!) / 9!\n\nLogic:\n1. PROBABILITY BOTTOM: Total circular arrangements of 10 people = 9!.\n2. PROBABILITY TOP (\"GOOD\" ways): Fuse [P1-P2-P3]. 1 block + 7 people =\n8 entities.\n3. Anchor the fused block to kill the circle. Arrange the remaining\n7 entities in a straight line (7!).\n4. Arrange the 3 distinct people inside their block (3!)."
  }
];
